...
export default function Headappart() {
  return (
    <header className="relative h-screen flex items-center justify-center bg-fixed bg-center bg-cover" style={{backgroundImage:`url('/RBG.jpg')`}}>
